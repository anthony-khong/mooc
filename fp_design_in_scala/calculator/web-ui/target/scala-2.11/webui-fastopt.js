...
$c_Lcalculator_Calculator$.prototype.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr = (function(name, refs) {
...
$c_Lcalculator_Calculator$.prototype.calculator$Calculator$$evalSignal$1__T__Lcalculator_Signal__sci_Map__T2 = (function(name, exprSig, namedExpressions$1) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(namedExpressions$1$1, exprSig$1) {
    return (function() {
  ...
  })(namedExpressions$1, exprSig));
  return new $c_T2().init___O__O(name, new $c_Lcalculator_Signal().init___F0(expr))
});
$c_Lcalculator_Calculator$.prototype.checkWithTrace$1__p1__T__sci_Map__sci_List__Z = (function(name, refs, path) {
  _checkWithTrace: while (true) {
    var this$1 = path;
    var elem = name;
    if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, elem)) {
      return true
    } else {
      var refExpr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, refs);
      if ($is_Lcalculator_Ref(refExpr)) {
        var x2 = $as_Lcalculator_Ref(refExpr);
        var refName = x2.name$2;
        var x$1 = name;
        var this$2 = path;
        var temp$path = new $c_sci_$colon$colon().init___O__sci_List(x$1, this$2);
        name = refName;
        path = temp$path;
        continue _checkWithTrace
      } else {
        return false
      }
    }
...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(namedExpressions$1) {
    return (function(x0$1$2) {
      var x0$1 = $as_T2(x0$1$2);
      if ((x0$1 !== null)) {
        var name = $as_T(x0$1.$$und1$f);
        var exprSig = $as_Lcalculator_Signal(x0$1.$$und2$f);
        return $m_Lcalculator_Calculator$().calculator$Calculator$$evalSignal$1__T__Lcalculator_Signal__sci_Map__T2(name, exprSig, namedExpressions$1)
      } else {
        throw new $c_s_MatchError().init___O(x0$1)
      }
    })
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, refs) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if (this.checkWithTrace$1__p1__T__sci_Map__sci_List__Z(name, refs, $m_sci_Nil$())) {
        return (NaN)
      } else {
        expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, refs);
        continue _eval
      }
      ...
      var lExpr = x4.a$2;
      var rExpr = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(lExpr, refs) + this.eval__Lcalculator_Expr__sci_Map__D(rExpr, refs))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var lExpr$2 = x5.a$2;
      var rExpr$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(lExpr$2, refs) - this.eval__Lcalculator_Expr__sci_Map__D(rExpr$2, refs))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var lExpr$3 = x6.a$2;
      var rExpr$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(lExpr$3, refs) * this.eval__Lcalculator_Expr__sci_Map__D(rExpr$3, refs))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var lExpr$4 = x7.a$2;
      var rExpr$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(lExpr$4, refs) / this.eval__Lcalculator_Expr__sci_Map__D(rExpr$4, refs))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0.0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else if (($uD(delta$1.apply__O()) === 0.0)) {
        var array = [((-$uD(b$2.apply__O())) / (2.0 * $uD(a$2.apply__O())))];
        ...
        var array$1 = [(((-jsx$5) + jsx$4) / (2.0 * jsx$3)), (((-jsx$2) - $uD($g.Math.sqrt(a$3))) / (2.0 * $uD(a$2.apply__O())))];
